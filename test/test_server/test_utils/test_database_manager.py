...
class TestUserDatabase(unittest.TestCase):
    ...
    def test_create_user(self):
        ...
        self.db_manager.create_user(username='testuser', full_name='Test UserTable', email='testuser@example.com',
                                    hashed_password='testpassword', disabled=True, is_admin=True)
        ...
        self.db_manager.create_user(username='testuser2', full_name='Test UserTable 2', email='testuser2@example.com',
    ...
    def test_make_user_admin(self):
        self.db_manager.create_user(username='testuser', full_name='Test UserTable', email='testuser@example.com',
                                    hashed_password='testpassword', disabled=False, is_admin=False)
...
class TestInventoryItemDatabase(unittest.TestCase):
    ...
    def test_create_item(self):
        ...
        self.db_manager.create_item(name='Item 10', owner=1, description='Description 1', price=10.0)
    ...
    def test_get_items_by_owner(self):
        ...
        item3 = InventoryItemTable(item_id=30, name='Item 30', owner=2, description='Description 3', price=30.0)
        with self.db_manager.Session() as session:
    ...
    def test_remove_user_cascades_to_items(self):
        ...
        with self.db_manager.Session() as session:
            session.add(item)
            session.commit()
        item = InventoryItemTable(item_id=10, name='Item 10', owner=10, description='Description 1', price=10.0)
        with self.db_manager.Session() as session:
            session.add(item)
